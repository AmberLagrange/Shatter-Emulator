...
class CPU
{
    ...
    public:
        ...
        const Instruction instructions[0x100] = 
        {
            ...
            INSTRUCTION("LD B,(HL)",        std::bind(&CPU::opcode0x45, this), 1,  8,  8),
            ...
            INSTRUCTION("LD D,(HL)",        std::bind(&CPU::opcode0x55, this), 1,  8,  8),
        ...
        const Instruction instructionsCB[0x100] = 
        {
            ...
            INSTRUCTION("RL A",             std::bind(&CPU::opcodeCB0x16, this), 2,  8,  8),
